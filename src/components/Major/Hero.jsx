...
function Hero() {
  ...
  return (
    <div className="h-auto md:h-screen w-full rounded-md flex flex-col lg:flex-row justify-between items-center lg:justify-between md:items-center overflow-hidden relative py-10 lg:py:0 ">
      <ShootingStars />
      <StarsBackground />
      <Spotlight
      ...
      <div className="mt-20 lg:mt-0 relative w-full z-10 p-4 px-6 lg:px-8 text-center lg:text-start lg:ml-10">
      ...
      <div className="relative h-80 md:h-[100%] w-full">
        ...
        <div className="absolute w-full md:w-[95%] bottom-0 h-80 md:h-[95%] z-10">
          <World data={sampleArcs} globeConfig={globeConfig} />
        </div>
      </div>
      <div className="absolute z-30 bottom-5 md:bottom-10 text-center mx-auto w-full text-neutral-300">
        Backed by
