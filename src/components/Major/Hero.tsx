...
function Hero() {
  ...
  return (
    <div className="minxl:py:0 relative flex h-auto w-full flex-col-reverse items-center justify-between overflow-hidden rounded-md py-10 minxl:h-screen minxl:flex-row minxl:items-center minxl:justify-between">
      ...
      <StarsBackground />
      {/* <Spotlight
        className="-top-24 left-0 minxl:hidden minxl:-top-20 minxl:left-0"
        fill="#ffd590"
      /> */}
      ...
      <div className="relative mt-14 flex h-80 w-full items-start justify-center md:mt-0 md:h-[36rem] minxl:h-[100%]">
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 flex h-40 w-full select-none items-center justify-center bg-gradient-to-b from-transparent dark:to-black to-white">
          <p
            className={cn(
